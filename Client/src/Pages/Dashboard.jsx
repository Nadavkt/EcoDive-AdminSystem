...
export default function Dashboard() {
  ...
  <>
      ...
      <p className="text-white mb-6">Say Hello to Your Nicely Dashaboard !!</p>

      {/* Row 1 - Counters */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6" style={{color: 'white'}}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="shadow rounded p-4 width">
